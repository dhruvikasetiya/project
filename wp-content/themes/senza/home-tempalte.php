...
<div class="conatiner">
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel team-carousel position-relative" style="margin-top: -97px; padding: 0 30px;">
                        ...
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Practice Area</p>
                            <div class="team-img position-relative">
                                <img class="img-fluid" src="<?php echo  get_template_directory_uri();  ?>/img/team-5.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    ...
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo  get_template_directory_uri();  ?>/img/testimonial-1.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Client Name</h5>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo  get_template_directory_uri();  ?>/img/testimonial-2.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Client Name</h5>
                            <p class="m-0">Profession</p>
                        </div>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo  get_template_directory_uri();  ?>/img/testimonial-3.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Client Name</h5>
                            <p class="m-0">Profession</p>
                        </div>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="<?php echo  get_template_directory_uri();  ?>/img/testimonial-4.jpg" style="width: 80px; height: 80px;" alt="">
                        <div class="pl-4">
                            <h5>Client Name</h5>
                            <p class="m-0">Profession</p>
                        </div>
  ...
  ?>
    ...
    <script src="<?php echo  get_template_directory_uri();  ?>/https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="<?php echo  get_template_directory_uri();  ?>/https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="<?php echo  get_template_directory_uri();  ?>/lib/tempusdominus/js/moment.min.js"></script>
    <script src="<?php echo  get_template_directory_uri();  ?>/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="<?php echo  get_template_directory_uri();  ?>/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
